...
class ServiceResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'Service Kendaraan';

    protected static string | \UnitEnum | null $navigationGroup = 'Kendaraan';

    protected static ?int $navigationSort = 3;

    protected static ?string $navigationLabel = 'Service Kendaraan';

    // Label untuk judul halaman dan tombol (Singular)
    protected static ?string $modelLabel = 'Service Kendaraan';

    // Label untuk data jamak (Plural)
    protected static ?string $pluralModelLabel = 'Service Kendaraan';

    ...
    <div class="page" style="--cols: {{ $cols }}; --rows: {{ $rows }};">
        <div class="grid" role="group" aria-label="Page {{ $pageIndex + 1 }}">
            @foreach ($page as $card)
                @php $thing = $card['thing']; $qr = $card['qr']; @endphp
                <div class="sticker" role="region" aria-label="Sticker {{ $thing->jenis_barang }}">
                    ...
                    <div class="info">
                        ...
                        <table class="w-full" aria-label="Informasi Kendaraan">
                            <tr>
                                ...
                                <td class="sep">:</td>
                                <td class="value">{{ $thing->jenis_barang }}</td>
                            </tr>
                            <tr>
                                <td class="label">Jenis</td>
                                <td class="sep">:</td>
                                <td class="value">{{ $thing->merk }}</td>
                            </tr>
                            <tr>
                                <td class="label">Merek</td>
                                <td class="sep">:</td>
                                <td class="value">{{ $thing->tipe }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="sep">:</td>
                                <td class="value">{{ $thing->pemilik }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
